...
abstract class Class implements ActiveRecordInterface
{
    ...
    public function setClassid($v)
    {
        ...
        if ($this->classid !== $v) {
            $this->classid = $v;
            $this->modifiedColumns[ClassTableMap::COL_CLASSID] = true;
        }
    ...
    public function setSubject($v)
    {
        ...
        if ($this->subject !== $v) {
            $this->subject = $v;
            $this->modifiedColumns[ClassTableMap::COL_SUBJECT] = true;
        }
    ...
    public function setCatalognumber($v)
    {
        ...
        if ($this->catalognumber !== $v) {
            ...
            $this->modifiedColumns[ClassTableMap::COL_CATALOGNUMBER] = true;
        }
    ...
    public function setSection($v)
    {
        ...
        if ($this->section !== $v) {
            $this->section = $v;
            $this->modifiedColumns[ClassTableMap::COL_SECTION] = true;
        }
    ...
    public function setInstructornetid($v)
    {
        ...
        if ($this->instructornetid !== $v) {
            ...
            $this->modifiedColumns[ClassTableMap::COL_INSTRUCTORNETID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            return $startcol + 5; // 5 = ClassTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ClassTableMap::COL_CLASSID)) {
            $modifiedColumns[':p' . $index++]  = 'classID';
        }
        if ($this->isColumnModified(ClassTableMap::COL_SUBJECT)) {
            $modifiedColumns[':p' . $index++]  = 'subject';
        }
        if ($this->isColumnModified(ClassTableMap::COL_CATALOGNUMBER)) {
            $modifiedColumns[':p' . $index++]  = 'catalogNumber';
        }
        if ($this->isColumnModified(ClassTableMap::COL_SECTION)) {
            $modifiedColumns[':p' . $index++]  = 'section';
        }
        if ($this->isColumnModified(ClassTableMap::COL_INSTRUCTORNETID)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ClassTableMap::COL_CLASSID)) {
            $criteria->add(ClassTableMap::COL_CLASSID, $this->classid);
        }
        if ($this->isColumnModified(ClassTableMap::COL_SUBJECT)) {
            $criteria->add(ClassTableMap::COL_SUBJECT, $this->subject);
        }
        if ($this->isColumnModified(ClassTableMap::COL_CATALOGNUMBER)) {
            $criteria->add(ClassTableMap::COL_CATALOGNUMBER, $this->catalognumber);
        }
        if ($this->isColumnModified(ClassTableMap::COL_SECTION)) {
            $criteria->add(ClassTableMap::COL_SECTION, $this->section);
        }
        if ($this->isColumnModified(ClassTableMap::COL_INSTRUCTORNETID)) {
            $criteria->add(ClassTableMap::COL_INSTRUCTORNETID, $this->instructornetid);
        }
    ...
    {
        $criteria = ChildClassQuery::create();
        $criteria->add(ClassTableMap::COL_CLASSID, $this->classid);
