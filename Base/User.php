...
abstract class User implements ActiveRecordInterface
{
    ...
    public function setNetID($v)
    {
        ...
        if ($this->netid !== $v) {
            $this->netid = $v;
            $this->modifiedColumns[UserTableMap::COL_NETID] = true;
        }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UserTableMap::COL_NETID)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserTableMap::COL_NETID)) {
            $criteria->add(UserTableMap::COL_NETID, $this->netid);
        }
        if ($this->isColumnModified(UserTableMap::COL_EMAIL)) {
    ...
    /**
     * Generic method to set the primary key (netid column).
     *
