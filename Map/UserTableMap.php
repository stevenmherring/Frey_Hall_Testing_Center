...
class UserTableMap extends TableMap
{
    ...
    /**
     * the column name for the netId field
     */
    const COL_NETID = 'user.netId';
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UserTableMap::COL_NETID);
            $criteria->addSelectColumn(UserTableMap::COL_EMAIL);
        } else {
            $criteria->addSelectColumn($alias . '.firstName');
            $criteria->addSelectColumn($alias . '.lastName');
            $criteria->addSelectColumn($alias . '.netId');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(UserTableMap::COL_NETID, (array) $values, Criteria::IN);
        }
