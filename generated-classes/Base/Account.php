...
abstract class Account implements ActiveRecordInterface
{
    ...
    /**
     * @var        ChildProfile one-to-one related ChildProfile object
     */
    ...
    public function setLogin($v)
    {
        ...
        if ($this->login !== $v) {
            $this->login = $v;
            $this->modifiedColumns[AccountTableMap::COL_LOGIN] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : AccountTableMap::translateFieldName('Login', TableMap::TYPE_PHPNAME, $indexType)];
            $this->login = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : AccountTableMap::translateFieldName('Password', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doSave(ConnectionInterface $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->singleProfile !== null) {
                if (!$this->singleProfile->isDeleted() && ($this->singleProfile->isNew() || $this->singleProfile->isModified())) {
                    $affectedRows += $this->singleProfile->save($con);
                }
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(AccountTableMap::COL_LOGIN)) {
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            if (null !== $this->singleProfile) {
                ...
                $result[$key] = $this->singleProfile->toArray($keyType, $includeLazyLoadColumns, $alreadyDumpedObjects, true);
            }
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AccountTableMap::COL_LOGIN)) {
            $criteria->add(AccountTableMap::COL_LOGIN, $this->login);
        }
        if ($this->isColumnModified(AccountTableMap::COL_PASSWORD)) {
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($deepCopy) {
            ...
            $relObj = $this->getProfile();
            if ($relObj) {
                $copyObj->setProfile($relObj->copy($deepCopy));
            }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep) {
            if ($this->singleProfile) {
                $this->singleProfile->clearAllReferences($deep);
            }
        } // if ($deep)
    ...
    if (is_callable(array('\Profile', $name))) {
        if (!$delegate = $this->getProfile()) {
            $delegate = new ChildProfile();
