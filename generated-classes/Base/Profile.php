...
abstract class Profile implements ActiveRecordInterface
{
    ...
    public function setTelephone($v)
    {
        ...
        if ($this->telephone !== $v) {
            $this->telephone = $v;
            $this->modifiedColumns[ProfileTableMap::COL_TELEPHONE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ProfileTableMap::translateFieldName('Email', TableMap::TYPE_PHPNAME, $indexType)];
            $this->email = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ProfileTableMap::translateFieldName('Telephone', TableMap::TYPE_PHPNAME, $indexType)];
            $this->telephone = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ProfileTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = ProfileTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Profile'), 0, $e);
        }
    }
    ...
    {
        if ($this->aAccount !== null && $this->id !== $this->aAccount->getId()) {
            $this->aAccount = null;
        }
    } // ensureConsistency
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ProfileTableMap::COL_TELEPHONE)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProfileTableMap::COL_TELEPHONE)) {
            $criteria->add(ProfileTableMap::COL_TELEPHONE, $this->telephone);
        }
        if ($this->isColumnModified(ProfileTableMap::COL_ID)) {
    ...
    public function hashCode()
    {
        ...
        //relation profile_fk_c88697 to table account
    ...
    {
        if (null !== $this->aAccount) {
            $this->aAccount->removeProfile($this);
        }
        $this->email = null;
        $this->telephone = null;
        $this->id = null;
