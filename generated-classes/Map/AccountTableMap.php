...
class AccountTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Login', 'Password', ),
        self::TYPE_CAMELNAME     => array('id', 'login', 'password', ),
        self::TYPE_COLNAME       => array(AccountTableMap::COL_ID, AccountTableMap::COL_LOGIN, AccountTableMap::COL_PASSWORD, ),
        self::TYPE_RAW_COLNAME   => array('COL_ID', 'COL_LOGIN', 'COL_PASSWORD', ),
        self::TYPE_FIELDNAME     => array('id', 'login', 'password', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Login' => 1, 'Password' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'login' => 1, 'password' => 2, ),
        self::TYPE_COLNAME       => array(AccountTableMap::COL_ID => 0, AccountTableMap::COL_LOGIN => 1, AccountTableMap::COL_PASSWORD => 2, ),
        self::TYPE_RAW_COLNAME   => array('COL_ID' => 0, 'COL_LOGIN' => 1, 'COL_PASSWORD' => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'login' => 1, 'password' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    {
        $this->addRelation('Profile', '\\Profile', RelationMap::ONE_TO_ONE, array('id' => 'id', ), 'CASCADE', null);
    } // buildRelations()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(AccountTableMap::COL_LOGIN);
