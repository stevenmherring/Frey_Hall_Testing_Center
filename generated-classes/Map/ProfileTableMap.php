...
class ProfileTableMap extends TableMap
{
     ...
     */
    const COL_TELEPHONE = 'profile.TELEPHONE';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Email', 'Telephone', 'Id', ),
        self::TYPE_CAMELNAME     => array('email', 'telephone', 'id', ),
        self::TYPE_COLNAME       => array(ProfileTableMap::COL_EMAIL, ProfileTableMap::COL_TELEPHONE, ProfileTableMap::COL_ID, ),
        self::TYPE_RAW_COLNAME   => array('COL_EMAIL', 'COL_TELEPHONE', 'COL_ID', ),
        self::TYPE_FIELDNAME     => array('email', 'telephone', 'id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Email' => 0, 'Telephone' => 1, 'Id' => 2, ),
        self::TYPE_CAMELNAME     => array('email' => 0, 'telephone' => 1, 'id' => 2, ),
        self::TYPE_COLNAME       => array(ProfileTableMap::COL_EMAIL => 0, ProfileTableMap::COL_TELEPHONE => 1, ProfileTableMap::COL_ID => 2, ),
        self::TYPE_RAW_COLNAME   => array('COL_EMAIL' => 0, 'COL_TELEPHONE' => 1, 'COL_ID' => 2, ),
        self::TYPE_FIELDNAME     => array('email' => 0, 'telephone' => 1, 'id' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addForeignPrimaryKey('ID', 'Id', 'INTEGER' , 'account', 'ID', true, null, null);
    } // initialize()
    ...
    {
        $this->addRelation('Account', '\\Account', RelationMap::MANY_TO_ONE, array('id' => 'id', ), 'CASCADE', null);
    } // buildRelations()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ProfileTableMap::COL_TELEPHONE);
